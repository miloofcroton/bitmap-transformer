...
describe('Pixel Reader', () => {
    ...
    it('reads pixel from buffer', done => {
        ...
        reader.on('end', () => {
            ...
            assert.deepEqual(colors[1], { offset: 24, b: 220, g: 63, r: 63 });
            assert.deepEqual(colors[2], { offset: 48, b: 220, g: 63, r: 63 });
            done();
        ...
        for(let i = 0; i < 3; i++) {
            buffer.writeUInt8(220, i * 24);
            buffer.writeUInt8(63, i * 24 + 8);
            buffer.writeUInt8(63, i * 24 + 16);
        }
